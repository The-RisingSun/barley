<template>
  <div id="detail">
    ...
    <div class="navclass">
      <a href="#">大麦</a> >
      <a href="#">北京</a> >
      <a class="active" href="#">电影</a> >
      <a href="#">大型多媒体励志互动儿童剧《奇门遁甲》(11月)</a>
    </div>
    <div class="main">
      <div class="choosebuy">
        <div class="pic">
        ...
        <div class="score">
          ...
          <div class="txt">
            <p>演出时间</p>
            <p>2017-12-23-2017-12-26</p>
          </div>
          <div class="txt">
            <p>演出场馆</p>
            <p>中国儿童中心剧院-海淀</p>
            <p><img src="/static/img/listlogo1.jpg" alt="">交通路线</p>
          </div>
          <div class="txt">
            <p>票品支持</p>
            <p><span>$</span>&nbsp;返积分</p>
          ...
          <div class="txt">
            <p>实票配送</p>
            <p>同城满100.00元免运费,不满收10.00元,发货后1-3天到达</p>
          </div>
        </div>
      </div>
